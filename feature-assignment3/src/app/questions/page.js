...
Add a "Go Back" button on the detail page to return to the list.`,
  ...
  return (
    <div>
      ...
      <button onClick={() => setQuestion("Question2")}style={{ marginRight: "15px", padding: "16px 30px" }}>
        Question2
      </button>
      <button onClick={() => setQuestion("Question3")}style={{ marginRight: "15px", padding: "16px 30px" }}>
        Question3
      </button>
      <button onClick={() => setQuestion("Question4")}style={{ marginRight: "15px", padding: "16px 30px" }}>
        Question4
      </button>
      <button onClick={() => setQuestion("Question5")}style={{ marginRight: "15px", padding: "16px 30px" }}>
        Question5
      </button>
      <button onClick={() => setQuestion("Question6")}style={{ marginRight: "15px", padding: "16px 30px" }}>
        Question6
      </button>
